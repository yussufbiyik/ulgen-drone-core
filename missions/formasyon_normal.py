...
async def main(sim_instance=0):
    ...
    mission = FormasyonMission(drone, drone_controller, takeoff_altitude=5.0, user_selected_formation_type="cizgi", formation_distance=10.0, formation_duration=5000)
    await mission.run()
